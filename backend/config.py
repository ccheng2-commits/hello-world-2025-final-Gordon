...
INCOMING_DIR = DATA_DIR / "incoming"      # Raw iris photos from camera
...
for dir_path in [INCOMING_DIR, PROCESSED_DIR, FFT_DIR, CODES_DIR, LOGS_DIR]:
    dir_path.mkdir(parents=True, exist_ok=True)

# Image processing settings
IRIS_CROP_SIZE = 512  # Size of the 1:1 square crop (pixels)
